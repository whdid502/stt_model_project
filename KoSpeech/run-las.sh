...
ARCHITECTURE='las'
DATASET_PATH='C:/Users/ansdu/Desktop/KsponSpeech/original'
...
SAMPLE_RATE=16000
N_MELS=80
FEATURE_EXTRACT_BY='librosa'        # You can set 'librosa', 'torchaudio'
TRANSFORM_METHOD='mfcc'          # Support feature : spect, mel, mfcc, fbank
