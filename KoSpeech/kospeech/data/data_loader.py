    ...
    def run(self):
        ...
        while True:
            ...
            for _ in range(self.batch_size):
                ...
                # TODO : delete
                # print("-" * 50)
                # print("[CHECK] feature_vector size : ", feature_vector.size())
                # print("[CHECK] transcript size : ", len(transcript))
                # print("-" * 50)
...
def _collate_fn(batch):
    ...
    # TODO : delete
    # print("#"*100)
    # print("[CHECK] max_seq_size : " , max_seq_size)
    # print("[CHECK] seqs size : ", seqs.size())
    # print("#"*100)
...
def split_dataset(opt, transcripts_path):
    ...
    trainset_list = list()
    train_num = int(len(audio_paths) * (1-0.1))
